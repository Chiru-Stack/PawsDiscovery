...
const Modal = ({ open, close }) => {
	...
	const editPasswordCallback = () => {
		...
		if (
			passwordValues.newPassword.trim() !== passwordValues.confirmPassword
		) {
			return setErrors({
				confirmPassword: Strings.passwordsNotMatch[lang],
			});
		}
	...
	const threadContent = (
		<ModalBody title={Strings.newThread[lang]} onClick={close}>
			<form className="form_inner" onSubmit={onSubmit}>
				<FormCardItem
					title={Strings.threadTitle[lang]}
					error={errors.title}
				>
					<div
						className={
							errors.title ? "form_block error" : "form_block"
						}
					>
						<Input
							name="title"
				...
				<FormCardItem title={Strings.content[lang]} error={errors.body}>
					<TextareaForm
						className={
							errors.body ? "form_block error" : "form_block"
						}
						name="body"
						value={values.body}
				...
				<FileUploadForm sendFiles={getFile} clearFiles={clearFiles} />

				<FormCardItem
					title={Strings.chooseABoard[lang]}
	...
	const banContent = (
		<ModalBody title={Strings.banUser[lang]} onClick={close}>
			<form className="form_inner" onSubmit={banSubmit}>
				<FormCardItem
					title={Strings.reason[lang]}
					error={errors.reason}
				>
					<div
						className={
							errors.reason ? "form_block error" : "form_block"
						}
					>
						<Input
							name="reason"
				...
				<FormCardItem
					title={Strings.banDuration[lang]}
					error={errors.expiresAt}
				>
					<div
						className={
							errors.expiresAt ? "form_block error" : "form_block"
						}
	...
	const uploadContent = (
		<ModalBody title={Strings.newFile[lang]} onClick={close}>
			<form className="form_inner" onSubmit={uploadSubmit}>
				...
				<FormCardItem
					title={Strings.chooseAFolder[lang]}
	...
	const editPasswordContent = (
		<ModalBody title={Strings.passwordChange[lang]} onClick={close}>
			<form className="form_inner" onSubmit={editPasswordSubmit}>
				<FormCardItem
					title={Strings.password[lang]}
					error={errors.password}
				>
					<div
						className={
							errors.password ? "form_block error" : "form_block"
						}
					>
						<Input
							type="password"
				...
				<FormCardItem
					title={Strings.newPassword[lang]}
				...
				<FormCardItem
					title={Strings.confirmPassword[lang]}
	...
	return <section className={modalOpen}>{content}</section>;
};
